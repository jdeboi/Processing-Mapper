...
public class Keystone {
	 ...
	 * @return
	 */
	public CornerPinSurface createQuadPinSurface(int w, int h, int res) {
		CornerPinSurface s = new QuadPinSurface(parent, w, h, res);
		surfaces.add(s);
		return s;
	}
	
	public CornerPinSurface createTriPinSurface(int w, int h, int res) {
		CornerPinSurface s = new TriPinSurface(parent, w, h, res);
		surfaces.add(s);
		return s;
	}
